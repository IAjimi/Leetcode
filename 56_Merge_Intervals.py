...
if __name__ == '__main__':
	assert [[1, 3], [5, 6], [8, 18]] == Solution().merge(intervals=[[1, 3], [5, 6], [8, 10], [9, 18]])
	assert [[1,6],[8,10],[15,18]] == Solution().merge(intervals = [[1,3],[2,6],[8,10],[15,18]])
	...
	assert [[1,10]] == Solution().merge(intervals=[[2,3],[4,5],[6,7],[8,9],[1,10]])
	assert [[0,5]] == Solution().merge(intervals=[[1,4],[0,2],[3,5]])
	assert [[2,4],[5,5]] == Solution().merge(intervals=[[2,3],[5,5],[2,2],[3,4],[3,4]])