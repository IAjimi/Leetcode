...
if __name__ == '__main__':
	assert [[0,0], [1, 3], [6, 9]] == Solution().insert(intervals=[[1, 3], [6, 9]], newInterval=[0, 0])  # first interval
	assert [[1,5],[6,9]] == Solution().insert(intervals=[[1,3],[6,9]], newInterval=[2,5])  # merge into interval
	assert [[1, 3], [5, 13]] == Solution().insert(intervals=[[1, 3], [6, 9]], newInterval=[5, 13])  # merge into interval
	assert [[0, 13]] == Solution().insert(intervals=[[1, 3], [6, 9]], newInterval=[0, 13])  # merge all intervals
	assert [[1,3], [4,5], [6, 9]] == Solution().insert(intervals=[[1, 3], [6, 9]], newInterval=[4,5])  # in between intervals
	assert [[1, 3], [6, 9], [11,13]] == Solution().insert(intervals=[[1, 3], [6, 9]], newInterval=[11, 13])  # last interval

	assert [[0,0], [1,2],[3,5],[6,7],[8,10],[12,16]] == Solution().insert(intervals=[[1,2],[3,5],[6,7],[8,10],[12,16]], newInterval=[0,0])
